...
const Profile = () => {
  ...
  const renderBackdrop = (props) => (
    <div className="fixed z-[1040] inset-0 bg-[#555] opacity-50" {...props} />
  );
  ...
  return (
    <div>
      ...
      <div className="md:mx-[5%]">
          ...
          <div className="max-[767px]:text-center max-[767px]:mt-7">
            ...
            <div className="mb-24 flex flex-col gap-3">
              ...
              <p>
                <Link
                  to=""
                  className="text-2xl md:text-3xl text-[var(--lighter-red,_rgb(127,29,29))]"
                >
                  Change Password
                </Link>
              </p>
            ...
            <div className="my-5 max-[767px]:w-[80%] mx-auto max-[767px]:text-center">
              <button
                ...
                className="bg-[var(--lighter-blue,_#29335c)] inline-block text-white text-2xl rounded-xl text-center my-5 py-4 w-[50%] md:w-[40%] max-[767px]:mx-auto md:mr-5 max-[767px]:block"
              >
                EDIT PROFILE
              </button>
              <Link
                to="/home"
                onClick={onLogout}
                className="py-4 bg-red w-[50%] text-center inline-block max-[767px]:block max-[767px]:mx-auto text-white text-2xl md:w-[40%] md:ml-5 rounded-xl"
              >
                LOGOUT
              </Link>
            </div>
        ...
        <Modal
          className="fixed z-[1040] left-[10%] top-[20%] md:left-[20%] bg-white shadow-3xl rounded-md md:w-[60%] w-[80%]"
          show={showModal}
          onHide={handleClose}
        ...
        >
          <div>
            <button
              type="button"
              className="font-bold text-5xl text-right w-[90%] inline-block mt-6 mx-8"
              onClick={handleClose}
            >
              x
            </button>
            ...
            <div className="w-[85%] mb-8 mx-auto">
              <div className="text-left inline-block w-[50%]">
                <button
                  onClick={handleClose}
                  className="bg-red text-white text-center py-3 px-[20%] rounded-lg "
                >
                  Cancel
                </button>
              </div>
              <div className="text-right inline-block w-[50%]">
                <button
                  ...
                  className="bg-[var(--lighter-blue,_#29335c)] text-white text-center py-3 px-[20%] rounded-lg "
                >
                  Update
                </button>
              </div>
