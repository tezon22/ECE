...
const L2 = () => {
    ...
    const courses1 = ['MAT 201', 'FEG 201', 'FEG 221','FEG 211', 'FEG 213', 'FEG 250', 'FEG 281', 'ICH 201', 'CSC 201']
    const courses2 = ['MAT 202', 'FEG 202', 'FEG 242', 'FEG 212', 'FEG 214', 'FEG 215', 'FEG 280', 'FEG 282', 'CSC 202', 'BUS 204']
    return (
      <div>
        <Navbar/>
               ...
               {courses1.map((course1) =>{
                return (
                    ...
                    <div className="my-6 md:my-8 p-3 md:p-4 bg-slate-200 rounded-full font-semibold text-sm md:text-xl">
                        {course1} <span className="text-xl md:text-2xl float-right"><AiFillFolder/></span>
                    </div>
                </Link>
                )
               })}
                ...
                return (
                    ...
                    <div className="my-6 md:my-8 p-3 md:p-4 bg-slate-200 rounded-full font-semibold text-sm md:text-xl">
                        {course2} <span className="text-xl md:text-2xl float-right"><AiFillFolder/></span>
                    </div>
                </Link>
                )
               })}
