...
const SecondL1 = () => {
      ...
      function calculate (mat102 , feg102, phy102, ich102, ich112, feg103, phy108, gst102, gst106, gst110){
            return (
                  mat102 * 3 + feg102 * 2 + phy102 * 3 + ich102 * 2 + ich112 * 2 + feg103 * 2 + phy108 * 1 + gst102 * 1 + gst106 * 2 + gst110 * 1
            )
      }
    ...
    <div className="text-[#29335C] lg:mx-[15%]">
          ...
          <div className="mb-28">
                ...
                <div className="flex my-5 text-[#29335C] mx-2 md:mx-4">
                      ...
                      <input className="bg-slate-200 rounded-full py-1 text-center font-bold w-[33%] mx-2" type="number" name="mat_grd" placeholder="Enter:" value={mat102 } onChange={(e) => setMat102(e.target.value < 6 ? e.target.value : toast('Grade no dey pass 5'))} />
                ...
                <div className="flex my-5 text-[#29335C] mx-2 md:mx-4">
                      ...
                      <input className="bg-slate-200 rounded-full py-1 text-center font-bold w-[33%] mx-2" type="number" name="feg_grd" placeholder="Enter:" value={feg102 } onChange={(e) => setFeg102(e.target.value < 6 ? e.target.value : toast('Grade no dey pass 5'))} />
                ...
                <div className="flex my-5 text-[#29335C] mx-2 md:mx-4">
                      ...
                      <input className="bg-slate-200 rounded-full py-1 text-center font-bold w-[33%] mx-2" type="number" name="phy_grd"  placeholder="Enter:" value={phy102 } onChange={(e) => setPhy102(e.target.value < 6 ? e.target.value : toast('Grade no dey pass 5'))} />
                ...
                <div className="flex my-5 text-[#29335C] mx-2 md:mx-4">
                      ...
                      <input className="bg-slate-200 rounded-full py-1 text-center font-bold w-[33%] mx-2" type="number" name="ich1_grd" placeholder="Enter:" value={ich102 } onChange={(e) => setIch102(e.target.value < 6 ? e.target.value : toast('Grade no dey pass 5'))} />
                ...
                <div className="flex my-5 text-[#29335C] mx-2 md:mx-4">
                      ...
                      <input className="bg-slate-200 rounded-full py-1 text-center font-bold w-[33%] mx-2" type="number" name="ich2_grd"  placeholder="Enter:" value={ich112} onChange={(e) => setIch112(e.target.value < 6 ? e.target.value : toast('Grade no dey pass 5'))} />
                ...
                <div className="flex my-5 text-[#29335C] mx-2 md:mx-4">
                      ...
                      <input className="bg-slate-200 rounded-full py-1 text-center font-bold w-[33%] mx-2" type="number" name="feg2_grd"  placeholder="Enter:" value={feg103} onChange={(e) => setFeg103(e.target.value < 6 ? e.target.value : toast('Grade no dey pass 5'))} />
                ...
                <div className="flex my-5 text-[#29335C] mx-2 md:mx-4">
                      ...
                      <input className="bg-slate-200 rounded-full py-1 text-center font-bold w-[33%] mx-2" type="number" name="phy2_grd" placeholder="Enter:" value={phy108} onChange={(e) => setPhy108(e.target.value < 6 ? e.target.value : toast('Grade no dey pass 5'))} />
                ...
                <div className="flex my-5 text-[#29335C] mx-2 md:mx-4">
                      ...
                      <input className="bg-slate-200 rounded-full py-1 text-center font-bold w-[33%] mx-2" type="number" name="eng_grd" placeholder="Enter:" value={gst102} onChange={(e) => setGst102(e.target.value < 6 ? e.target.value : toast('Grade no dey pass 5'))} />
                ...
                <div className="flex my-5 text-[#29335C] mx-2 md:mx-4">
                      ...
                      <input className="bg-slate-200 rounded-full py-1 text-center font-bold w-[33%] mx-2" type="number" name="social_grd" placeholder="Enter:" value={gst106} onChange={(e) => setGst106(e.target.value < 6 ? e.target.value : toast('Grade no dey pass 5'))} />
                ...
                <div className="flex my-5 text-[#29335C] mx-2 md:mx-4">
                      ...
                      <input className="bg-slate-200 rounded-full py-1 text-center font-bold w-[33%] mx-2" type="number" name="igbo_grd" placeholder="Enter:" value={gst110} onChange={(e) => setGst110(e.target.value < 6 ? e.target.value : toast('Grade no dey pass 5'))} />
                ...
                <div className="my-8 w-[50%]">
                    <p className="md:w-1/2 md:mx-10 font-bold ">
                          Total Credit Unit:<span className="bg-slate-200 py-1 rounded-full text-center ml-4 w-[50%]  inline-block">19</span>
                    </p>
                </div>
                <p className="my-4 md:text-xl font-bold mx-4 text-right px-5 w-[50%]">CGPA: {calc / 19} </p>
                </div>
          </div>
