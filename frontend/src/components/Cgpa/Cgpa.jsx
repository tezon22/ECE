      ...
      <div className="text-[#29335C] lg:mx-[15%]">
          <div className="flex my-5 mx-4">
              ...
              <div className="w-11/12 text-center md:text-2xl font-bold mt-2">
                  Select your level (CGPA)
              </div>       
          </div>
          <Link to="/L1cgpa">
              <div className="rounded-2xl md:rounded-3xl md:text-xl bg-slate-200 text-center font-medium py-10 md:py-16 my-8 md:my-14 mx-10 md:mx-24">
                  100 level
              </div>
          </Link>
          <Link to="/L2cgpa">
          ...
          <a href="#a">
              <div className="rounded-2xl md:rounded-3xl md:text-xl bg-slate-200 my-8 md:my-14 mx-10 md:mx-24">
