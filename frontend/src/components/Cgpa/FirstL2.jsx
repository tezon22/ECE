    ...
    <div className="container-fluid text-[#29335C] lg:mx-[15%]">
          ...
          <div className="mb-28">
                ...
                <div className="flex my-5 text-[#29335C] mx-2 md:mx-4">
                      ...
                      <input className="bg-slate-200 rounded-full py-1 text-center font-bold w-[33%] mx-2" type="number" name="ich_grd" placeholder="Enter:" />
                      <input className="bg-slate-200 rounded-full py-1 text-center font-bold w-[33%] mx-2" type="number" name="ich_unt" value="2" disabled />
                </div>
                <div className="flex my-5 text-[#29335C] mx-2 md:mx-4">
                ...
                <div className="md:flex my-8">
                    <p className="md:w-1/2 md:mx-10 font-bold m-4">
                          Total Credit Unit:<span className="bg-slate-200 py-1 rounded-full text-center ml-4 w-[50%] md:w-[40%] inline-block">20</span>
                    </p>
